...
#echo 'source <(curl -sSL https://www.dropbox.com/s/x6fp9f14ob1i5ez/gnula.sh)' > /bin/automatizar.sh && chmod +x /binar/automatizar.sh
#echo 'source <(curl -sSL https://www.dropbox.com/s/bs1sx98qrzbid8o/killram.sh)' > /bin/gnula.sh && chmod +x /bin/gnula.sh
echo -ne " COMPILANDO BINARIO DE AUTOPTIMIZACIONES "
if wget https://www.dropbox.com/s/bs1sx98qrzbid8o/killram.sh &>/dev/null -O /bin/automatizar.sh &>/dev/null ; then
...
if wget https://www.dropbox.com/s/x6fp9f14ob1i5ez/gnula.sh &>/dev/null -O /bin/gnula.sh &>/dev/null ; then
echo -e " \033[1;32m DONE \n" && msg -bar3 
