...
echo -e "\033[1;37m      ã€      drowkid01-ADM Mods.       ã€‘\033[0m"
...
rules:
- DOMAIN-SUFFIX,local,drowkid01-ADM
- DOMAIN-SUFFIX,google.com,drowkid01-ADM
- DOMAIN-KEYWORD,google,drowkid01-ADM
- DOMAIN,google.com,drowkid01-ADM
- DOMAIN-SUFFIX,ad.com,drowkid01-ADM
- SRC-IP-CIDR,192.168.1.201/32,drowkid01-ADM
- IP-CIDR,127.0.0.0/8,drowkid01-ADM
- GEOIP,IR,drowkid01-ADM
- MATCH, drowkid01-ADM
...
sed -i 's/drowkid01-ADM/✵ℂ𝕙𝕦𝕞𝕠𝔾ℍ-𝔸𝔻𝕄✵/g' /root/.config/clash/config.yaml
