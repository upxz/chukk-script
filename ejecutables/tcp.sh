#!/bin/bash
#19/12/2019
source <(curl -sSL https://www.dropbox.com/s/yog8eklvcvz6zya/msg)
clear
msg -bar 
...
clear
msg -bar
echo -e " TCP Aceleración (BBR/Plus) ADM-drowkid01 By @drowkid01 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
$(msg -bar)
